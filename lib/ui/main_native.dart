...
class _PlatformChannelState extends State<PlatformChannel> {
  ...
  static const MethodChannel webViewChannel = MethodChannel('samples.flutter.io/webview');
  ...
  Future<void> _openWebView() async {
    try {
      print("Trying to open screen");
      await webViewChannel.invokeMethod("openWebView", "https://conferencecompass.com");
    } catch (e)  {
      print(e);
    }
  }
